...
export default function SocialGrowthError({
  error,
  reset,
}: {
  ...
  return (
    <div className="p-6">
      <EmptyState
        icon={AlertTriangle}
        title="Failed to load Social Growth"
        description="We encountered an error while fetching the Social Growth module data. Please try again."
        variant="error"
        actions={
