...
export default function SEOPhaseError({
  error,
  reset,
}: {
  ...
  return (
    <div className="p-6">
      <EmptyState
        icon={AlertTriangle}
        title="Failed to load SEO Cluster"
        description="We encountered an error while fetching the SEO module data. Please try again."
        variant="error"
        actions={
